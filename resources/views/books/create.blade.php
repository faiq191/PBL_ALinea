        ...
        <div class="max-w-2xl w-full bg-[#ffffff] border border-gray-100 rounded-3xl p-8 shadow-xl">
            ...
            <form action="/books" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div x-show="mode === 'google'" x-data="{ query: '', results: [], selected: null }" x-transition class="space-y-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <input type="text" x-model="query" 
                            ...
                            class="flex-1 px-4 py-2 rounded-xl bg-[#e8edf2] outline-none focus:ring-2 focus:ring-[#1a3a5c]">
                        <button type="button" 
                ...
                <div x-show="mode === 'manual'" x-transition class="space-y-6">
                        ...
                        <div class="bg-[#f8fafc] p-5 rounded-2xl border border-gray-100 flex flex-col md:flex-row gap-5 items-center">
                            <div class="flex-shrink-0 relative group">
                                ...
                                <template x-if="(cover_source === 'file' && !filePreview) || (cover_source === 'url' && !imageUrl)">
                                    <div class="w-24 h-32 bg-white rounded-xl flex flex-col items-center justify-center border border-dashed border-[#1a3a5c]/35 text-[#1a3a5c]/60 shadow-sm">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full px-4 py-2 rounded-xl bg-[#e8edf2] border-none outline-none focus:ring-2 focus:ring-[#1a3a5c]">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-600 text-xs mt-1 font-semibold">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div x-show="mode === 'manual'" x-transition class="space-y-6">
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="type_id" class="w-full px-4 py-2 rounded-xl bg-[#e8edf2] outline-none">
                        ...
                        <div>
                            ...
                            <select name="year_id" class="w-full px-4 py-2 rounded-xl bg-[#e8edf2] outline-none">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2 bg-white border border-gray-100 p-4 rounded-2xl @error('genre_ids') ring-2 ring-red-500 @enderror">
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="/koleksi" class="px-8 py-3 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition text-center">
                        Batal
                    </a>
                </div>
            </form>
