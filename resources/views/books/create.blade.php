...
<body class="bg-[#2c2c2c] p-8" x-data="{ mode: 'manual' }">
...
<div class="max-w-2xl mx-auto bg-[#e6ddd6] rounded-3xl p-8 shadow-xl">
    ...
    <form action="/books" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div x-show="mode === 'existing'" x-transition>
            ...
            <p class="text-xs text-gray-500 mt-2 italic">*Memilih buku ini akan otomatis menggunakan data yang sudah tersedia.</p>
        </div>
