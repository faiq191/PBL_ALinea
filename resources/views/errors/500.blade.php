    ...
    <div class="min-h-[calc(100vh-80px)] flex items-center justify-center px-6 pt-20 pb-16">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="fade-in fade-in-delay-1">
                <span class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-[11px] font-bold tracking-widest uppercase bg-rose-500/10 text-rose-500 border border-rose-500/20 mb-4">
