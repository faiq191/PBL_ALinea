...
<html lang="id">
<head>
    <title>Sedang Pemeliharaan - ALinea</title>
    ...
    <div class="min-h-[calc(100vh-80px)] flex items-center justify-center px-6 pt-20 pb-16">
        <div class="w-full max-w-lg text-center">
            ...
            <div class="fade-in fade-in-delay-1">
                <span class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-[11px] font-bold tracking-widest uppercase bg-amber-500/10 text-amber-600 border border-amber-500/20 mb-4">
                    <i data-lucide="hard-hat" class="w-3 h-3"></i> 503
                </span>
                ...
                <p class="text-sm text-gray-400 leading-relaxed max-w-sm mx-auto mb-8">
                    ALinea sedang dalam proses pemeliharaan untuk pengalaman yang lebih baik. Kami akan segera kembali, terima kasih atas kesabaranmu!
                </p>
            </div>
