...
<html lang="id">
<head>
    <title>Akses Ditolak - ALinea</title>
        ...
        <div class="w-full max-w-lg text-center">
            ...
            <div class="fade-in fade-in-delay-1">
                <span class="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-[11px] font-bold tracking-widest uppercase bg-[#1a3a5c]/5 text-[#1a3a5c]/60 border border-[#1a3a5c]/10 mb-4">
                    <i data-lucide="shield-off" class="w-3 h-3"></i> 403
                </span>
                ...
                <p class="text-sm text-gray-400 leading-relaxed max-w-sm mx-auto mb-8">
                    Kamu tidak memiliki izin untuk mengakses halaman ini. Silakan login dengan akun yang sesuai atau kembali ke beranda.
                </p>
            </div>
